...
import notuserfriendly.mapatlasesrecut.utils.DecorationHolder;

import static notuserfriendly.mapatlasesrecut.client.MapAtlasesClient.DELETE_MARKER_SPRITE;
import static notuserfriendly.mapatlasesrecut.client.MapAtlasesClient.FOCUS_MARKER_SPRITE;
...
public class DecorationBookmarkButton extends AtlasButton {
    ...
    public Tooltip createTooltip() {
        if (control && holder.canFocusMarker()) {
            return Tooltip.create(Component.translatable("tooltip.map_atlases_recut.focus_marker"));
        }
        if (shifting && holder.canDeleteMarker()) {
            return Tooltip.create(Component.translatable("tooltip.map_atlases_recut.delete_marker"));
        }
