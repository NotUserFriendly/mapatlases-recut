...
import notuserfriendly.mapatlasesrecut.networking.C2STeleportPacket;
...
public class MapWidget extends AbstractAtlasDisplay implements Renderable, GuiEventListener, NarratableEntry {
        ...
        if (animation || scaleAlpha != 0) {
            ...
            if (a > 10) {
                ...
                graphics.drawString(mc.font,
                        Component.translatable("message.map_atlases_recut.map_scale", String.format("%.1f", targetZoomLevel)),
    ...
    private void renderPositionText(GuiGraphics graphics, Font font, int mouseX, int mouseY) {
        ...
        String coordsToDisplay = Component.translatable("message.map_atlases_recut.coordinates", pos.x(), pos.z()).getString();
        AtlasScreenUtils.drawScaledComponent(
