...
public class ShearButton extends AtlasButton {
    ...
    protected ShearButton(int pX, int pY, AtlasOverviewScreen screen) {
        ...
        Tooltip tooltip = Tooltip.create(Component.translatable("message.map_atlases_recut.shear"));
        if (Minecraft.getInstance().options.advancedItemTooltips) {
            Tooltip t2 = Tooltip.create(Component.translatable("message.map_atlases_recut.shear.info")
